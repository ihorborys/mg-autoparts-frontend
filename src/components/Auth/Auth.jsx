...
//     if (error) {
//       toast.error(`Помилка Google: ${error.message}`);
//       setLoading(false); // при помилці — розблоковуємо
//     }
//     // при успіху — сторінка редиректиться, тому loading так і залишається true
//   };
//
//   const handleAuth = async (e) => {
//     e.preventDefault();
...
//         setLoading(false);
//       }
//       // при успішному вході — AuthContext сам обробить SIGNED_IN,
//       // loading залишається true поки не відбудеться перехід
//     }
//   };
//
//   return (
...
//       </h2>
//
//       {/* fieldset з disabled блокує всі дочірні елементи одночасно */}
